...
namespace Nohros.Data
{
  ...
  /// </summary>
  public interface IQuery<out TResult, in T1>
  {
    /// <summary>
    /// Executes the command represented by the
    /// <see cref="IQuery{T}"/> object.
    /// </summary>
    /// <param name="arg1">
  ...
  /// </summary>
  public interface IQuery<out TResult, in T, in T2>
  {
    /// <summary>
    /// Executes the command represented by the
    /// <see cref="IQuery{T}"/> object.
    ...
    /// </param>
    TResult Execute(T arg1, T2 arg2);
  }
  ...
  /// </summary>
  public interface IQuery<out TResult, in T, in T2, in T3>
  {
    /// <summary>
    /// Executes the command represented by the
    /// <see cref="IQuery{T}"/> object.
    ...
    /// </param>
    TResult Execute(T arg1, T2 arg2, T3 arg3);
  }
  ...
  /// </summary>
  public interface IQuery<out TResult, in T, in T2, in T3, in T4>
  {
    /// <summary>
    /// Executes the command represented by the
    /// <see cref="IQuery{T}"/> object.
    ...
    /// </param>
    TResult Execute(T arg1, T2 arg2, T3 arg3, T4 arg4);
  }
  ...
  /// </summary>
  public interface IQuery<out TResult, in T, in T2, in T3, in T4, in T5>
  {
    /// <summary>
    /// Executes the command represented by the
    /// <see cref="IQuery{T}"/> object.
    ...
    /// </param>
    TResult Execute(T arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5);
  }
  ...
  /// </summary>
  public interface IQuery<out TResult, in T, in T2, in T3, in T4, in T5, in T6>
  {
    /// <summary>
    /// Executes the command represented by the
    /// <see cref="IQuery{T}"/> object.
    ...
    /// </param>
    TResult Execute(T arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6);
  }
                          ...
                          in T7>
  {
    ...
    /// </param>
    TResult Execute(T arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7);
  }
