...
namespace Nohros.Concurrent
{
  ...
  /// <see cref="Thread"/>or <see cref="ThreadPool"/> work item, but a higher
  ...
  /// cancelled. Once a computation hs completed, the computation cannot be
  ...
  /// types of the for <see cref="IFuture{T}"/> and return <c>null</c> as a
  /// result of the underlying task.
  /// </para>
  /// <para>
  /// Behing the scenes, <see cref="IFuture{T}"/> are queued to the
  /// <see cref="ThreadPool"/>.
  /// </para>
  /// </remarks>
