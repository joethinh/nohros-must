...
{
  public class JsonDataFieldInteger: DataFieldInteger, IJsonDataField<int>
  {
    #region .ctor
    /// <summary>
    ...
    #region IJsonDataField<int> Members
    /// <summary>
    ...
    /// </param>
    public IJsonToken<int> GetValue(IDataReader reader) {
