...
{
  /// <summary>
  /// Provides a generic implementation of the <see cref="IPrincipal"/>
  /// interface.
  /// </summary>
  /// <remarks>The <see cref="Name"/> property is used to uniquely identifies
  /// the principal.</remarks>
  public class Principal : IPrincipal
  {
    ...
    #region .ctor
    /// <summary>
    /// Initializes a new instance of the <see cref="Principal"/> class by
    /// using specified principal name.
    /// </summary>
    ...
    /// <summary>
    /// Explicit converts a string to a <see cref="Principal"/> object.
    /// </summary>
    /// <param name="name">The string to be converted.</param>
    /// <returns>A <see cref="Principal"/> whose identification is 
    /// <paramref name="name"/>.</returns>
    public static explicit operator Principal(string name) {
    ...
    /// another specified <see cref="IPrincipal"/> refers to the same
    /// principal.
    /// </summary>
    ...
    /// consistent from one execution of an application to another execution to
    /// another execution of the same application</item>
    /// <item>
