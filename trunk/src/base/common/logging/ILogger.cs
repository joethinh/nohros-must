...
namespace Nohros.Logging
{
    ...
    public interface ILogger
    {
        ...
        /// level of the logger with the <see cref="LogLevel.Debug"/> level and if it is enabled the
        /// message is logged.
        /// </remarks>
        void Debug(string message);

        /// <summary>
        /// Log a message object with the <see cref="LogLevel.Debug"/> level including the stack trace of
        /// the <see cref="Exception "/> passed as a parameter.
        /// </summary>
        /// <param name="message">The message object to log.</param>
        ...
        /// level of the logger with the <see cref="LogLevel.Error"/> level and if it is enabled the
        /// message is logged.
        /// </remarks>
        void Error(string message);

        /// <summary>
        /// Log a message object with the <see cref="LogLevel.Error"/> level including the stack trace of
        /// the System.Exception passed as a parameter.
        /// </summary>
        /// <param name="message">The message object to log.</param>
        /// <param name="exception">The exception to log, including its stack trace.</param>
        ...
        /// level of the logger with the <see cref="LogLevel.Fatal"/> level and if it is enabled the
        /// message is logged.
        /// </remarks>
        void Fatal(string message);

        /// <summary>
        /// Log a message object with the <see cref="LogLevel.Fatal"/> level including the stack trace
        /// of the <see cref="Exception"/> passed as a parameter.
        /// </summary>
        /// <param name="message">The message object to log.</param>
        /// <param name="exception">The exception to log, including its stack trace.</param>
        /// <remarks>
        ...
        /// level of the logger with the <see cref="LogLevel.Info"/> level and if it is enabled the
        /// message is logged.
        /// </remarks>
        void Info(string message);
        
        /// <summary>
        /// Logs a message object with the <see cref="LogLevel.Info"/> level including the stack trace
        /// of the <see cref="Exception"/> passed as a parameter.
        /// </summary>
        /// <param name="message">The message object to log.</param>
        /// <param name="exception">The exception to log, including its stack trace.</param>
        ...
        /// level of the logger with the <see cref="LogLevel.Warn"/> level and if it is enabled the
        /// message is logged.
        /// </remarks>
        void Warn(string message);

        /// <summary>
        /// Log a message object with the <see cref="LogLevel.Warn"/> level including the stack trace of
        /// the <see cref="Exception"/> passed as a parameter.
        /// </summary>
        /// <param name="message">The message object to log.</param>
        /// <param name="exception">The exception to log, including its stack trace.</param>
