...
namespace Nohros.Data.TransferObjects
{
  ...
  public class TableTransferObject: IDataTransferObject, IEnumerable
  {
    ...
    {
      /// <summary>
      /// An string array containing the columns values.
      /// </summary>
      public string[] values;

      /// <summary>
      /// An integer representing the index of the node within
      /// the <see cref="TableTransferObject"/>.
      /// </summary>
      public int index;
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="TableNode"/> class with
      /// is empty and positioned at the index zero.
      /// </summary>
      public TableNode() { }

      /// <summary>
      /// Initialzes a new instance of the <see cref="TableNode"/> class by
      /// using the specified node index.
      /// </summary>
      /// <param name="index">
      /// The index of the node within the <see cref="TableTransferObject"/>.
      /// </param>
      ...
      /// <summary>
      /// Initializes a new instance oF the <see cref="TableNode"/> class by
      /// using the specified row number and values.
      /// </summary>
      /// <param name="row">
      /// The number of the row that this node represents.
      /// </param>
      /// <param name="str">
      /// An string array containing the values of the columns.
      /// </param>
      public TableNode(int row, string[] str) {
        this.index = row;
        values = str;
      }
    }
    ...
    public TableTransferObject(params string[] columns) {
      ...
      root_ = new TableNode(0);
      columns_ = columns;
    }
    #endregion

    /// <summary>
    /// Adds the specified values to the a new row within the
    /// <see cref="TableTransferObject"/> object.
    /// </summary>
    /// <param name="values">
    /// An array of strings containing the value to be added to the table.
    /// </param>
    ...
    /// <summary>
    /// Gets the number of rows actually contained in the
    ...
    /// <summary>
    /// Gets the number of columns contained in the
    /// <see cref="TableTransferObject"/>.
    /// </summary>
    /// <remarks>
    /// Retrieving the value of this property is an O(1) operation.
