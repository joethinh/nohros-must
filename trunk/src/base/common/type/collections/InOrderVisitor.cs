...
namespace Nohros.Collections
{
  ...
  /// <remarks>This class only wraps the methods of the <see cref="Visitor"/>.
  ...
  /// within a <see cref="IDictionary&gt;T&lt;"/></example>
  /// </summary>
  ...
  public class InOrderVisitor<T1, T2>: IVisitor<T1, T2>
  {
    ...
    #region .ctor
    /// <summary>
    /// Initializes a new instance of the InOrderVisitor class by using the
    /// specified visitor.
    /// </summary>
