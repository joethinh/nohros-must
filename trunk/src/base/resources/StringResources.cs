...
namespace Nohros.Resources
{
  public sealed class StringResources
  {
    ...
    /// <summary>
    /// Looks up a localized string similar to [An invalid collection of attributes has been supplied,
    /// or a required attribute has not been supplied].
    /// </summary>
    /// <remarks>The value returned by this property is equals to the value returned by the <see cref="Provider_Attributes"/>
    /// property. This property exists only for legacy compatibility.</remarks>
    internal static string DataProvider_Provider_Attributes {
      get { return Provider_Attributes; }
    }
    ...
    internal static string Provider_Attributes {
      get { return GetString("Provider_Attributes"); }
    }
    ...
    internal static string Provider_Option_MissingAt {
      get { return GetString("Provider_Option_MissingAt"); }
    }
    #endregion
    ...
    /// <summary>
    /// Looks up a localized string similar to [The type "{0}" could not be
    /// loaded].
    /// </summary>
