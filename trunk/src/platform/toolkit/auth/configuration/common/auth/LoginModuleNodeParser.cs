...
using R = Nohros.Security.Resources;
...
namespace Nohros.Configuration
{
  public partial class LoginModuleNode
  {
    ...
    public static LoginModuleNode Parse(XmlElement element,
      ...
      var login_module = new LoginModuleNode(name, type, control_flag, location);
    ...
    static LoginModuleControlFlag GetControlFlag(XmlElement element) {
      ...
      throw new ConfigurationException(
        R.Configuration_InvalidLoginModuleControlFlag.Fmt(control_flag_string));
    }
  }
}
