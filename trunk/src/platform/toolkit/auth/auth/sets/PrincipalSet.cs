...
namespace Nohros.Security.Auth
{
  ...
  /// </summary>
  public class PrincipalSet : ISecureSet<IPrincipal>, IEnumerable<IPrincipal>,
                              IEnumerable
  {
    readonly SecureSet<IPrincipal> principals_;

    #region .ctor
    /// <summary>
    /// Initializes a new instance of the <see cref="PrincipalSet"/> class that
