...
namespace Nohros.Metrics
{
  ...
  /// </summary>
  public interface IAsyncMetricsRegistry
  {
    /// <summary>
    ...
    /// </returns>
    IAsyncHistogram GetHistogram(MetricName name, bool biased);
    ...
    /// </param>
    /// <returns></returns>
    IAsyncMeter GetMeter(MetricName name, string event_type,
      TimeUnit rate_unit);
    ...
    /// </returns>
    IAsyncTimed GetTimer(MetricName name, TimeUnit duration_unit);
    ...
    /// </returns>
    bool TryGetHistogram(MetricName name, out IAsyncHistogram histogram);
    ...
    /// <paramref name="name"/> exists; otherwise, <c>false</c>.
    /// </returns>
    bool TryGetTimer(MetricName name, out IAsyncTimed timer);
    ...
    /// <paramref name="name"/> exists; otherwise, <c>false</c>.
    /// </returns>
    bool TryGetMeter(MetricName name, out IAsyncMeter meter);
