...
namespace Nohros.Data.Informix
{
  /// <summary>
  ...
  public class InformixConnectionProvider : IConnectionProvider
  {
    ...
    const string kClassName = "Nohros.Data.Informix.InformixConnectionProvider";
    ...
    /// <see cref="InformixConnectionProvider"/> class using the specified
    /// connection string.
    /// </summary>
    public InformixConnectionProvider(string connection_string)
    ...
    /// </summary>
    public InformixConnectionProvider(string connection_string, string schema) {
    ...
    /// </remarks>
    public IfxConnection CreateConnection() {
      return new IfxConnection(connection_string_);
    }
