...
using Nohros.Data.MySql.Extensions;
...
namespace Nohros.Data.MySql
{
  ...
  public class MySqlQueryExecutor : IQueryExecutor
  {
    ...
    /// </summary>
    /// <param name="mysql_connection_provider">
    /// A <see cref="MySqlConnectionProvider"/> that can be used to create
    ...
    /// </param>
    public MySqlQueryExecutor(MySqlConnectionProvider mysql_connection_provider,
      CommandType default_command_type = CommandType.Text) {
      mysql_connection_provider_ = mysql_connection_provider;
